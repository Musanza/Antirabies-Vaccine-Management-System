		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<?php if ($_SESSION['type'] == 'Administrator' || $_SESSION['type'] == 'Warehouse Manager') {?>
					<li class="active"><a href="warehouse.php">Warehouse</a></li>
				<?php } ?>
								...
								<tbody>
									...
									while($row = $select->fetch_assoc()){ ?>
										<tr>
											...
											<td>
												<a href="config.php?delete_record=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
											</td>
										</tr>
									<?php } ?>
								</tbody>
					...
					<div class="col-md-3">
						...
						<div class="form">
							<form method="post">
								...
								<div class="form-group">
									<input type="text" name="date" id="datepicker2" class="form-control" placeholder="MM/DD/YYYY"><br>
									<label>Date Purchased</label>
								</div>
								<input type="submit" name="add-vaccine" value="Add" class="btn btn-primary">
							</form>
						</div>
					</div>
				</div>
